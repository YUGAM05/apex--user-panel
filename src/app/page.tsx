...
function RotatingBanner() {
    ...
    return (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 xl:px-8">
            <div className={`rounded-3xl md:rounded-[3rem] px-6 py-10 md:p-16 pb-16 flex flex-col md:flex-row items-center justify-between relative overflow-hidden transition-colors duration-700 shadow-xl md:shadow-2xl ${s.bgColor}`}>
                {/* Content */}
                <div className="relative z-10 max-w-2xl w-full flex flex-col items-center md:items-start text-center md:text-left">
                    <span className="inline-block px-4 py-1.5 mb-4 md:mb-6 text-xs md:text-sm font-bold text-white bg-white/20 rounded-full backdrop-blur-sm">
                        {s.tag}
                    </span>
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 md:mb-6 leading-[1.15]">
                        {s.title}
                    </h2>
                ...
                {/* Right Visual Side */}
                <div className="relative z-10 mt-10 md:mt-0 flex flex-col items-center justify-center shrink-0 md:mr-10">
                    <div className={`w-24 h-24 md:w-48 md:h-48 rounded-full ${s.circleBg} flex items-center justify-center mb-3 md:mb-6 transition-colors duration-700`}>
                        {s.icon}
                    </div>
